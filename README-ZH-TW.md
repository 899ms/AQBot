...
- **本機角色管理** — 將系統提示詞、頭像、標籤、開場白、開場問題、溫度和 Top P 儲存為可重複使用的會話模板。
- **一鍵使用角色** — 預設新建角色對話，也可從下拉選單套用到目前對話；角色對話保留角色名稱、頭像和藍色「角色」標記。
- **線上市場** — 從 prompts.chat 和 PlexPt 中文來源搜尋並安裝角色，安裝後可離線作為本機角色使用。
