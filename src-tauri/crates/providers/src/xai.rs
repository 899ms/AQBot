...
impl ProviderAdapter for XAIAdapter {
    ...
    async fn list_models(&self, ctx: &ProviderRequestContext) -> Result<Vec<Model>> {
        // Official GET /v1/models already includes image models (e.g. grok-imagine-*).
        // Do not call /image-generation-models: many proxies/ACL setups return 404 and
        // used to hard-fail the entire model sync.
